...
class SellerDoesNotExistsError(ServiceError):
    pass


class SellerCreationError(ServiceError):
    pass


class SellerBadRequest(ServiceError):
    pass


class SellerUpdateError(ServiceError):
    pass


class SellerDeleteError(ServiceError):
    pass
